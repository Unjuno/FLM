...
export const ApiInfo: React.FC = () => {
  ...
  const {
    ...
    execute: loadApiInfo,
    clearError,
  } = useAsyncOperation<ApiInfoWithKey>(loadApiInfoOperation, {
    autoExecute: false,
    logErrors: true,
    context: 'ApiInfo',
  });
  ...
  const handleCopyToClipboard = async (text: string, label: string) => {
    try {
      ...
      clearError();
      // エラーはuseAsyncOperationで処理されるため、ここではログのみ
    }
  };
                  ...
                  {apiInfo.apiKey.startsWith('***') ? (
                    ...
                    <>
                      ...
                      <button
                        className="copy-button"
                        onClick={() =>
                          handleCopyToClipboard(apiInfo.apiKey!, 'apikey')
                        }
                      >
            ...
            <div className="sample-code-container">
              ...
              >
                ...
                <button
                  className="copy-button"
                  onClick={() =>
                    handleCopyToClipboard(getSampleCode('python'), 'python')
                  }
                >
