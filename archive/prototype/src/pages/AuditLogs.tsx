...
export const AuditLogs: React.FC = () => {
  ...
  const virtualizer = useVirtualizer({
    ...
    estimateSize: () => 120, // 各ログアイテムの推定高さ
    overscan: 5, // 画面外のアイテム数
  });

  const shouldUseVirtualScroll = filteredLogs.length >= 50; // 50件以上で仮想スクロールを有効化
      ...
      <div className="audit-logs-container">
        ...
        <div className="audit-logs-content">
          ...
          {filteredLogs.length === 0 ? (
            ...
            <div
              ref={parentRef}
              className="audit-logs-list audit-logs-list-virtual"
              style={{
                height: '600px',
                overflow: 'auto',
              }}
