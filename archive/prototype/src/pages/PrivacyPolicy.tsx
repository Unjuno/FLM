        ...
        <div className="privacy-policy-content">
          ...
          <section className="privacy-policy-section">
            ...
            <div className="privacy-policy-text-content">
              ...
              <ul>
                <li>API設定情報（エンドポイント、認証情報、エンジン設定など）</li>
                <li>APIキー（AES-256-GCMで暗号化して保存、OSキーストアを使用）</li>
                <li>OAuthトークン（アクセストークン、リフレッシュトークン、AES-256-GCMで暗号化して保存）</li>
                <li>リクエストログ（リクエストボディは設定で無効化可能、マスク処理あり）</li>
                <li>パフォーマンスメトリクス（CPU/メモリ使用率、レスポンス時間など、設定で無効化可能）</li>
                <li>監査ログ（API操作履歴、IPアドレスはハッシュ化または設定で除外可能、ユーザーエージェントは簡略化）</li>
                <li>アラート履歴</li>
                <li>アプリケーション設定（テーマ、言語設定、ログ保持期間、診断機能の有効/無効、パフォーマンスメトリクス収集の有効/無効など）</li>
                <li>モデル管理情報（インストール済みモデル、使用回数など）</li>
                <li>デバイスID（リモート同期機能使用時のみ、SHA-256でハッシュ化）</li>
                <li>バックアップファイル（オプションで暗号化可能、パスワード保護）</li>
                <li>環境変数（アプリケーションの動作に必要な設定、機密情報を含む場合あり）</li>
              </ul>
              ...
              <ul>
                ...
                <li>診断情報（システム情報、30秒間のみ保持、診断機能が有効な場合のみ）</li>
                <li>レート制限情報（IPアドレスはハッシュ化）</li>
                <li>パフォーマンスメトリクス（CPU/メモリ使用率、レスポンス時間、パフォーマンスメトリクス収集が有効な場合のみ）</li>
              </ul>
              ...
              <p>
                <strong>注意</strong>: 診断機能はデフォルトで有効ですが、設定画面からいつでも無効化できます。
              ...
              <p>
                <strong>注意</strong>: パフォーマンスメトリクス収集はデフォルトで有効ですが、設定画面からいつでも無効化できます。
                収集されたメトリクスはデータベースに保存され、ログ保持期間設定に従って自動削除されます。
              </p>
              
              <h3>2.5 IPアドレスの使用</h3>
              <p>
                本アプリケーションは、以下の目的でIPアドレスを使用します：
              </p>
              <ul>
                <li><strong>監査ログ</strong>: 操作履歴の記録（設定で無効化可能、デフォルトでハッシュ化）</li>
                <li><strong>レート制限</strong>: 不正アクセスの防止（ハッシュ化して使用）</li>
              </ul>
              <p>
                <strong>プライバシー保護</strong>: IPアドレスはSHA-256でハッシュ化され、最初の8バイト（16文字）のみが使用されます。
                設定画面から監査ログへのIPアドレスの保存を無効化できます。
              </p>
              
              <h3>2.6 ログ保持期間設定</h3>
              <p>
                本アプリケーションは、以下のログの保持期間を設定できます：
              </p>
              <ul>
                <li><strong>リクエストログ</strong>: デフォルト30日（設定画面で変更可能、1日〜365日）</li>
                <li><strong>監査ログ</strong>: デフォルト90日（設定画面で変更可能、1日〜365日）</li>
                <li><strong>パフォーマンスメトリクス</strong>: リクエストログと同じ保持期間</li>
              </ul>
              <p>
                設定された保持期間を超えたログは自動的に削除されます。
              </p>
              ...
              <ul>
                <li><strong>エクスポート形式</strong>: CSV、JSON</li>
                <li><strong>エクスポートされるデータ</strong>:
                  <ul>
                    <li>リクエストログ（フィルタリング可能）</li>
                    <li>リクエストボディ（デフォルトで除外、オプションでマスク処理あり）</li>
                    <li>エクスポート日時</li>
                  </ul>
                </li>
                <li><strong>暗号化オプション</strong>: エクスポートファイルをパスワード保護（AES-256-GCM）</li>
                <li><strong>プライバシー保護</strong>: エクスポート時に機密情報のマスク処理を実行</li>
              </ul>
              <p>
              ...
              <ul>
                <li><strong>バックアップに含まれるデータ</strong>:
                  <ul>
                    <li>API設定情報（すべて）</li>
                ...
                <li><strong>バックアップ形式</strong>: JSON</li>
                <li><strong>暗号化オプション</strong>: バックアップファイルをパスワード保護（AES-256-GCM）</li>
                <li><strong>デフォルト暗号化設定</strong>: 設定画面でバックアップファイルをデフォルトで暗号化するオプションを有効化できます（プライバシー保護のため推奨）</li>
                <li><strong>保存場所</strong>: ユーザーが指定した場所</li>
              </ul>
              <p>
              ...
              <ul>
                ...
                <li><strong>保存場所</strong>: ブラウザのローカルストレージ（ユーザーのデバイスのみ）</li>
                <li><strong>追跡方式</strong>: オプトイン方式（ユーザーの同意が必要）</li>
                <li><strong>外部送信</strong>: データは外部サービスに送信されません（ローカルストレージのみ）</li>
                <li><strong>同意の管理</strong>: ユーザーはいつでも同意を撤回できます（ブラウザのローカルストレージから削除）</li>
              </ul>
              <p>
                <strong>注意</strong>: ダウンロード追跡は、ユーザーが明示的に同意した場合にのみ実行されます。
              ...
              <ul>
                ...
                <li><strong>送信情報</strong>: 検索クエリのみ（ユーザーが明示的に実行した場合のみ）</li>
                <li><strong>目的</strong>: モデルの検索と取得</li>
                <li><strong>個人情報</strong>: 個人情報は送信されません</li>
              </ul>
              
              <h4>2.13.3 リモート同期機能（オプション）</h4>
              <ul>
                <li><strong>接続先</strong>: GitHub Gist API、Google Drive API、Dropbox API（ユーザーが選択）</li>
                <li><strong>送信情報</strong>: 
                  <ul>
                    <li>設定データ（APIキーは含まれない）</li>
                    <li>デバイスID（SHA-256でハッシュ化、最初の8バイトのみ使用）</li>
                    <li>同期日時</li>
                  </ul>
                </li>
                <li><strong>目的</strong>: 設定のバックアップと複数デバイス間での同期</li>
                <li><strong>同意</strong>: ユーザーが明示的に有効化する必要があります（デフォルトで無効）</li>
                <li><strong>個人情報</strong>: APIキーなどの機密情報は送信されません</li>
                <li><strong>プライバシー保護</strong>: デバイスIDはハッシュ化され、元のデバイスIDを特定することはできません</li>
              </ul>
              
              <h4>2.13.4 APIテスト機能</h4>
              <ul>
                <li><strong>接続先</strong>: ユーザーが設定したAPIエンドポイント</li>
                <li><strong>送信情報</strong>: テストリクエスト（ユーザーが明示的に実行した場合のみ）</li>
                <li><strong>目的</strong>: APIの動作確認</li>
                <li><strong>個人情報</strong>: ユーザーが入力したデータのみが送信されます</li>
              </ul>
              ...
              <ul>
                ...
                <li><strong>エクスポート形式</strong>: JSON</li>
                <li><strong>保存場所</strong>: ユーザーが指定した場所</li>
                <li><strong>プライバシー保護</strong>: APIキーなどの機密情報はエクスポートされません。エクスポートされるのは設定情報のみです。</li>
              </ul>
              <p>
              ...
              <ul>
                <li><strong>機能</strong>: 定期的なタスクの実行（ログ削除、バックアップなど）</li>
                <li><strong>保存情報</strong>: スケジュール設定（ローカルのみ）</li>
                <li><strong>外部送信</strong>: なし</li>
                <li><strong>個人情報</strong>: 個人情報は含まれません</li>
              </ul>
              
              <h4>2.3.6 プラグインシステム（将来の機能）</h4>
              <ul>
                <li><strong>機能</strong>: サードパーティプラグインの実行</li>
                <li><strong>権限管理</strong>: プラグインごとに権限を設定可能（将来実装予定）</li>
                <li><strong>データアクセス</strong>: プラグインの権限に応じてデータアクセスを制限（将来実装予定）</li>
                <li><strong>個人情報</strong>: プラグインは、ユーザーが明示的に許可したデータのみにアクセスできます</li>
              </ul>
            </div>
          </section>
          ...
          <section className="privacy-policy-section">
            ...
            <div className="privacy-policy-text-content">
              ...
              <ul>
                ...
                <li>パフォーマンス監視と分析（パフォーマンスメトリクス収集が有効な場合のみ）</li>
                <li>アプリケーション機能の提供</li>
                <li>ユーザー設定の保存と復元</li>
                <li>不正アクセスの防止（レート制限、IPアドレスハッシュ化）</li>
                <li>システム診断（診断機能が有効な場合のみ）</li>
                <li>バックアップと復元</li>
                <li>複数デバイス間での設定同期（リモート同期機能が有効な場合のみ）</li>
              </ul>
            </div>
          </section>
          ...
          <section className="privacy-policy-section">
            ...
            <div className="privacy-policy-text-content">
              ...
              <ul>
                ...
                <li>IPアドレスのハッシュ化（監査ログ、レート制限、SHA-256の最初の8バイトを使用）</li>
                <li>ユーザーエージェントの簡略化（監査ログ、ブラウザ名のみ、バージョン情報は除外）</li>
                <li>デバイスIDのハッシュ化（リモート同期、SHA-256の最初の8バイトを使用）</li>
                <li>バックアップファイルの暗号化オプション（パスワード保護）</li>
                <li>ローカルデータベースへの安全な保存</li>
                <li>ネットワーク通信のセキュリティ（HTTPS使用時）</li>
                <li>エラーメッセージからの機密情報の除外（ファイルパス、環境変数、APIキーなどをマスク）</li>
                <li>本番環境でのログレベル制御（開発環境では詳細、本番環境ではエラーのみ）</li>
                <li>不正アクセスの防止</li>
              </ul>
            </div>
          </section>
          ...
          <section className="privacy-policy-section">
            ...
            <div className="privacy-policy-text-content">
              ...
              <ul>
                ...
                <li>ログの自動削除機能（設定した保持期間を超えたログは自動削除）</li>
          ...
          <section className="privacy-policy-section">
            ...
            <div className="privacy-policy-text-content">
              ...
              <p>
                ...
                詳細は<a href="https://unjuno.github.io/FLM/privacy.html" target="_blank" rel="noopener noreferrer">ウェブサイトのプライバシーポリシー</a>をご確認ください。
              </p>
            </div>
          </section>
