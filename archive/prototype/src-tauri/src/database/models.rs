...
impl ModelCategory {
    pub fn as_str(&self) -> &str {
        match self {
            ...
            ModelCategory::AudioGeneration => "audio-generation",
            ModelCategory::Embedding => "embedding",
            ModelCategory::VideoGeneration => "video-generation",
    ...
    pub fn from(s: &str) -> Self {
        match s {
            ...
            "image-generation" => ModelCategory::ImageGeneration,
            "audio-generation" => ModelCategory::AudioGeneration,
            "embedding" => ModelCategory::Embedding,
            "video-generation" => ModelCategory::VideoGeneration,
