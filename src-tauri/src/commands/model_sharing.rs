...
use crate::utils::model_sharing::{ModelSharingConfig, SharedModelInfo, share_model, search_shared_models, download_shared_model};
use crate::utils::error::AppError;
use std::path::PathBuf;

/// モデルを共有
#[tauri::command]
pub async fn share_model_command(
    config: ModelSharingConfig,
