...
use crate::dns::DnsChallengeHook;
...
pub struct AcmeConfig<EC: Debug, EA: Debug = EC> {
    ...
    pub(crate) dns_hook: Option<Arc<dyn DnsChallengeHook>>,
}
...
impl<EC: 'static + Debug, EA: 'static + Debug> AcmeConfig<EC, EA> {
    ...
    pub fn dns_hook(mut self, hook: Arc<dyn DnsChallengeHook>) -> Self {
