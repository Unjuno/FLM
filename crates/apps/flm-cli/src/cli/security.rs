...
pub enum SecuritySubcommand {
    ...
    /// Install packaged CA certificate to OS trust store
    #[command(name = "install-ca")]
    InstallCa {
        /// Path to CA certificate file (PEM format)
        /// If not specified, attempts to find flm-ca.crt in default cert directory
        #[arg(long)]
