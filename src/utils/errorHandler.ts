  ...
  if (error instanceof Error) {
    ...
    if (!category) {
      ...
      if (lowerErrorMessage.includes('ollama')) {
        ...
        lowerErrorMessage.includes('api') ||
        lowerErrorMessage.includes('eaddrinuse') ||
        lowerErrorMessage.includes('認証プロキシ')
      ) {
        finalCategory = ErrorCategory.API;
      } else if (
        lowerErrorMessage.includes('model') ||
        lowerErrorMessage.includes('ダウンロード')
      ) {
        finalCategory = ErrorCategory.MODEL;
      } else if (
        lowerErrorMessage.includes('database') ||
        lowerErrorMessage.includes('sql')
      ) {
